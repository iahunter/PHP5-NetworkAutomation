...
$HTML->breadcrumb("Log",$HTML->thispage);
   ...
   function alertContents() {
      if (http_request.readyState == 4) {
         if (http_request.status == 200) {
            ...
            setTimeout('makeGETRequest(\'logupdates.php?user={$USER}&tool={$TOOL}\')',1000);
         } else {
...
$BODY_EXTRA = " onLoad=\"setTimeout('makeGETRequest(\'logupdates.php?user={$USER}&tool={$TOOL}\')',100);\"";

$HTML->set("HEAD_EXTRA",$HEAD_EXTRA);
$HTML->set("BODY_EXTRA",$BODY_EXTRA);

print $HTML->header("Log Update Monitor");
    ...
    <tr>
        ...
        <td align="right">
            <ul class="object-tools">
                <li>
					<a href="/reports/netman-usage.php">Netman Utilization Report</a>
                </li>
            </ul>
        </td>
    </tr>
