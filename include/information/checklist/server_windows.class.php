...
class Checklist_Server_Windows	extends Checklist_Server
{
	public $type = "Checklist_Server_Windows";

	public function html_form_extended()
	{
		$OUTPUT = "";
		if ($this->data['type'] == "Server_Windows")	// This is important. Only change device type if this is the first base instance!
		{
			$SELECT = array(
				"Server_Windows_Generic"	=> "Windows - Generic",
				"Server_Windows_DC"			=> "Windows - Domain Controller",
				"Server_Windows_File"		=> "Windows - File Server",
				"Server_Windows_Web"		=> "Windows - Web Server",
			);
...
END;
	...
	public function initialize()
	{
		$TASKS = array(
			...
			"Services - Disable Print Spooler Service",
		);
		$this->addtasks($TASKS);
	}
