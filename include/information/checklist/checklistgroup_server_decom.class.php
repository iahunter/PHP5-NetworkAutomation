...
require_once "information/checklist/checklistgroup_server.class.php";

class Checklist_ChecklistGroup_Server_Decom	extends Checklist_ChecklistGroup_Server
{
	public $category = "Checklist";
	public $type = "Checklist_ChecklistGroup_Server_Decom";
	...
	public function html_detail()
	{
		...
		$CHILDTYPE = "Server_Decom";	// Server types
                ...
                <tr>
                    <td align="right">
                        <ul class="object-tools">
                            <li>
                                <a href="/information/information-add.php?parent={$this->data['id']}&category={$this->data['category']}&type={$CHILDTYPE}" class="addlink">Add Server Decom Checklist</a>
                            </li>
                        </ul>
                            </li>
                        </ul>
