...
class Provisioning_Device_IOS_SWI_ACC_2960X_24	extends Provisioning_Device_IOS_SWI_ACC_2960X
{
	public $type = "Provisioning_Device_IOS_SWI_ACC_2960X_24";
	public $customfunction = "Config";

	public function initialize()
	{
		$OUTPUT = "";
		// Add 24 downstream gigabit interfaces
		$RANGE = range(1,28);
