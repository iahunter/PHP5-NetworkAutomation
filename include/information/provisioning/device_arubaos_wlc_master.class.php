...
class Provisioning_Device_ArubaOS_WLC_Master	extends Provisioning_Device_ArubaOS_WLC
{
	public $type = "Provisioning_Device_ArubaOS_WLC_Master";
	...
	public function get_wlcs()
	{
		$SEARCH = array(
						...
						"type"			=> "device_arubaos_wlc_campus_%",
						"stringfield2"	=> "{$this->data["region"]}",
						);
		// Get all the CAMPUS WLC device ID's in OUR REGION ONLY for building tunnels to
