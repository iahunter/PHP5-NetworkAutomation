...
class SimpleTidyPageBuilder {
     ...
     */
    public function insertGuards($html) {
     ...
     */
    public function stripGuards($html) {
     ...
     */
    public function insertEmptyTagGuards($html) {
     ...
     */
    public function stripEmptyTagGuards($html) {
     ...
     *    @return string     The html with guards inserted.
     */
    public function insertTextareaSimpleWhitespaceGuards($html) {
     ...
     */
    public function insertWhitespaceGuards($matches) {
     ...
     *    @return string     The html with guards removed.
     */
    public function stripTextareaWhitespaceGuards($html) {
     ...
     */
    public function createEmptyForm($node) {
     ...
     *  @param object $node      Tidy XML node.
     */
    public function walkForm($node, $form, $enclosing_label = '') {
        if ($node->name == 'a') {
            $this->page->addLink($this->tags()->createTag($node->name, (array)$node->attribute)
                                              ->addContent($this->innerHtml($node)));
     ...
     *                                  tag we might be in.
     */
    public function addWidgetToForm($node, $form, $enclosing_label) {
     ...
     */
    public function indexWidgetById($widget) {
     ...
     */
    public function collectSelectOptions($node) {
        $options = array();
        if ($node->name == 'option') {
     ...
     */
    public function mergeAttribute($attributes, $raw) {
        $parts = explode('=', $raw);
     ...
     */
    public function dequote($quoted) {
     ...
     */
    public function collectFrames($node) {
        $frames = array();
        if ($node->name == 'frame') {
     ...
     */
    public function attachLabels($widgets_by_id, $labels) {
