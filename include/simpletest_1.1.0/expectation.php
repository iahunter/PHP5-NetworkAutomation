...
/**
 *    Compares an object member's value even if public.
 *    @package SimpleTest
 *    @subpackage UnitTester
 */
class MemberExpectation extends IdenticalExpectation {
    ...
    /**
     *    Extracts the member value even if public using reflection.
     *    @param string $name        Property name.
     *    @param object $object      Object to read.
     *    @return mixed              Value of property.
     */
    public function getProperty($name, $object) {
    ...
    /**
     *    Extracts a public member's value when reflection won't play ball.
     *    @param string $name        Property name.
     *    @param object $object      Object to read.
     *    @return mixed              Value of property.
     */
    public function getPrivatePropertyNoMatterWhat($name, $object) {
