...
class SimpleArguments {
     ...
     */
    public function parseArgument(&$arguments) {
     ...
     */
    public function nextNonFlagElseTrue(&$arguments) {
...
class SimpleHelp {
     ...
     */
    public function longestFlag($flag_sets) {
        $longest = 0;
     ...
     */
    public function renderFlagSet($flags, $explanation, $tab_stop) {
     ...
     */
    public function noDuplicateNewLines($text) {
        return preg_replace('/(\n+)/', "\n", $text);
    }
}
?>