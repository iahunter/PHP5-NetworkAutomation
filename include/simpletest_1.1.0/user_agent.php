...
class SimpleUserAgent {
    ...
    public $max_redirects = DEFAULT_MAX_REDIRECTS;
    public $proxy = false;
    public $proxy_username = false;
    public $proxy_password = false;
    public $connection_timeout = DEFAULT_CONNECTION_TIMEOUT;
